        ...
        <div className="space-y-1.5">
          ...
          <div className="bg-caldelo-surface rounded-[7px] px-2.5 py-2 flex items-center justify-between">
            <div>
              ...
              <p className="text-[7px] text-caldelo-muted">Jamie</p>
            </div>
          ...
          <div className="bg-caldelo-surface rounded-[7px] px-2.5 py-2 flex items-center justify-between">
            <div>
              <p className="text-[8px] text-caldelo-secondary leading-tight">Pickup</p>
          ...
          <div className="rounded-[7px] overflow-hidden">
            <div className="bg-caldelo-coral/15 px-2.5 py-0.5">
              <span className="text-[6px] text-caldelo-coral font-bold uppercase tracking-widest">AT 5:00PM</span>
            </div>
            <div className="bg-[#fff3f0] px-2.5 py-2 flex items-center justify-between">
              <div>
                <p className="text-[8px] text-caldelo-secondary leading-tight">Football practice</p>
          ...
          <div className="bg-caldelo-surface rounded-[7px] px-2.5 py-2 flex items-center justify-between">
            <div>
              <p className="text-[8px] text-caldelo-secondary leading-tight">Dinner</p>
              <p className="text-[9px] font-semibold leading-tight">You</p>
            </div>
            <span className="text-[7px] bg-caldelo-green/15 text-caldelo-green font-medium rounded-full px-2 py-0.5 whitespace-nowrap">You ✓</span>
          </div>
