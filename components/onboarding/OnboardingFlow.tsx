...
import Step1HouseholdName from '@/app/onboarding/steps/step-1-household'
import Step2Partner from '@/app/onboarding/steps/step-2-partner'
import Step3Children from '@/app/onboarding/steps/step-3-children'
import Step4Region from '@/app/onboarding/steps/step-4-region'
import Step5Events from '@/app/onboarding/steps/step-5-events'
import Step6Ownership from '@/app/onboarding/steps/step-6-ownership'
import Step7Done from '@/app/onboarding/steps/step-7-done'
...
export function OnboardingFlow() {
  ...
  function renderStep() {
    switch (step) {
      case 1: return <Step1HouseholdName data={onboardingData} onNext={onNext} onBack={onBack} />
      case 2: return <Step2Partner data={onboardingData} onNext={onNext} onBack={onBack} />
      case 3: return <Step3Children data={onboardingData} onNext={onNext} onBack={onBack} />
      case 4: return <Step4Region data={onboardingData} onNext={onNext} onBack={onBack} />
      case 5: return <Step5Events data={onboardingData} onNext={onNext} onBack={onBack} />
      case 6: return <Step6Ownership data={onboardingData} onNext={onNext} onBack={onBack} />
      case 7: return <Step7Done data={onboardingData} onNext={onNext} onBack={onBack} />
      default: return null
    }
  }
  ...
  return (
    <div className="max-w-[480px] w-full flex flex-col items-center">
      ...
      <div key={step} className={`${animationClass} w-full`}>
        {renderStep()}
      </div>
    </div>
  )
