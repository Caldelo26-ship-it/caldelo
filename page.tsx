...
const steps = [
  { number: '1', color: 'var(--navy)', title: 'Tell us about your home', desc: 'Answer a few quick questions about your household — takes under 60 seconds and we never share your data.' },
  { number: '2', color: 'var(--teal)', title: 'We find your best deals', desc: 'Caldelo scans hundreds of tariffs and providers across energy, EV, broadband and mobile instantly.' },
  { number: '3', color: 'var(--green)', title: 'Switch and start saving', desc: 'Choose the deals that work for you and switch with one click. We handle the rest — no hidden fees.' },
]

const reviews = [
  { text: "Switched my energy tariff through Caldelo and I'm already saving over £40 a month. The whole process took less than 60 seconds.", name: 'Sarah J.', location: 'Manchester', initials: 'SJ', color: 'var(--teal)' },
  { text: "Finally found a site that actually makes switching simple. Found a better EV tariff I didn't even know existed. Brilliant.", name: 'Mark T.', location: 'Bristol', initials: 'MT', color: 'var(--navy)' },
  { text: 'Saved £380 on my broadband and mobile combined. Caldelo is now the first place I go when any contract comes up for renewal.', name: 'Priya K.', location: 'London', initials: 'PK', color: 'var(--pink)' },
]
...
const faqs = [
  ...
  { q: 'How accurate are the savings shown?', a: 'Savings are based on current market tariffs and your household inputs. Actual savings may vary slightly depending on usage.' },
    ...
    <main>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerCopy}>
          © 2026 Caldelo. Registered in England & Wales. Caldelo is a free comparison service. We may receive a commission from providers when you switch.
        </div>
      </footer>
    </main>
  )
